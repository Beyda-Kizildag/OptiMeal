  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-12">
      ...
      <div className="hidden lg:block lg:col-span-5 xl:col-span-6 relative overflow-hidden">
        ...
        <ImageWithFallback
          src="https://images.unsplash.com/photo-1564093497595-593b96d80180?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFsdGh5JTIwYnJlYWtmYXN0JTIwYm93bCUyMGNvbG9yZnVsfGVufDF8fHx8MTc3NDMyOTYzOHww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
          alt="Healthy food"
        ...
        <div className="absolute inset-0 z-20 flex flex-col justify-end p-12 text-white">
          <div className="space-y-4">
            ...
            <p className="text-lg text-white/90">
              AI destekli kişiselleştirilmiş beslenme planlarıyla hedeflerinize ulaşın
            </p>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer">
                <input 
                  type="checkbox" 
                  className="w-4 h-4 rounded border-2 border-border text-primary focus:ring-2 focus:ring-primary/20 cursor-pointer"
                />
                <span className="text-sm text-foreground">Beni hatırla</span>
              </label>
